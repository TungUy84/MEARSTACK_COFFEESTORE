          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center gap-4">
              ...
              <ul className="hidden sm:flex items-center gap-4">
                ...
                {menu.map((menu) => (
                  <li key={menu.id}>
                    {menu.link === '/about' && menu.link === '/product' ? <Link
                      to={menu.link}
              ...
              <Link to="/cart" className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-1 px-4 rounded-full flex items-center gap-3">
                Giỏ Hàng
                {/* Biểu tượng giỏ hàng */}
